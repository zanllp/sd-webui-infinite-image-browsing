...
你可以在全局设置页面中指定启动IIB时恢复到哪一个快照，或者恢复到最后关闭前的工作区状态。`,
  ...
  sortByHighPrecisionDateAscending: '修改日期升序（高精度）',
  sortByHighPrecisionDateDescending: '修改日期降序（高精度）',
  sortByHighPrecisionCreatedDateAscending: '创建日期升序（高精度）',
  sortByHighPrecisionCreatedDateDescending: '创建日期降序（高精度）',
