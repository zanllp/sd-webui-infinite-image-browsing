...
You can specify which snapshot to restore to when starting IIB in the global settings page, or restore to the last workspace state before closing.`,
  ...
  sortByHighPrecisionDateAscending: 'Updated date ascending (High-precision)',
  sortByHighPrecisionDateDescending: 'Updated date descending (High-precision)',
  sortByHighPrecisionCreatedDateAscending: 'Created date ascending (High-precision)',
  sortByHighPrecisionCreatedDateDescending: 'Created date descending (High-precision)',
