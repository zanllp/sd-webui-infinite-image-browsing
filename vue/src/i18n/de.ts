...
export const de: Partial<IIBI18nMap> = {
  ...
  sortBySizeAscending: 'Größe aufsteigend',
  sortBySizeDescending: 'Größe absteigend',
  sortByHighPrecisionDateAscending: 'Datum aufsteigend (Hochpräzise)',
  sortByHighPrecisionDateDescending: 'Datum absteigend (Hochpräzise)',
  sortByHighPrecisionCreatedDateAscending: 'Erstellungsdatum aufsteigend (Hochpräzise)',
  sortByHighPrecisionCreatedDateDescending: 'Erstellungsdatum absteigend (Hochpräzise)',
