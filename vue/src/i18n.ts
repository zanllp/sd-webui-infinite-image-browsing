...
const de: Record<keyof typeof zh, string> = {
  ...
  "fuzzy-search-placeholder": "Geben Sie einen Teil der Bildinformationen oder des Dateinamens ein, um passende Ergebnisse zu finden",
  ...
  "selectExcludeTag": "(Optional) Wähle Tags zum Ausschließen aus",
  ...
  manualExitFullScreen: "Du hast das letzte Bild gelöscht und musst möglicherweise manuell den Vollbild-Vorschaumodus beenden",
  long_loading: "Ladezeit beträgt mehr als 5 Sekunden. Es könnte sich in Kürze wieder normalisieren. Falls das Problem bestehen bleibt, überprüfen Sie bitte die FAQ für Lösungen oder reichen Sie eine Fehlermeldung ein.",
  "walk-mode-move-message": "Im Walk-Modus ist das Verschieben des Verzeichnisses nur über 'Schnellzugriff' gestattet",
  ...
  needGenerateIdx: "Klicken Sie auf die Schaltfläche, um einen Index zur Bildersuche zu generieren. \n Dieser Vorgang kann einige Minuten in Anspruch nehmen.",
  search: "Suchen",
  ...
  unknownSavedDir: "Das Speicherverzeichnis konnte nicht gefunden werden (Einstellung für das Speicherverzeichnis in der Konfiguration)",
  ...
  tip: "Hinweis",
  startedAt: "Startzeit:"+" ",
  sortByDateAscending: "Aufsteigend nach Datum sortieren",
  sortByDateDescending: "Absteigend nach Datum sortieren",
  sortByCreatedDateAscending: "Aufsteigend nach Erstellungsdatum sortieren",
  sortByCreatedDateDescending: "Absteigend nach Erstellungsdatum sortieren",
  sortByNameAscending: "Aufsteigend nach Name sortieren",
  sortByNameDescending: "Absteigend nach Name sortieren",
  sortBySizeAscending: "Aufsteigend nach Grösse sortieren",
  sortBySizeDescending: "Absteigend nach Grösse sortieren",
  ...
  local: "Lokal",
  sendImageFailed: "Fehler beim Senden des Bildes. Bitte kontaktieren Sie den Entwickler mit der Fehlermeldung aus der Konsole.",
  ...
  deleteSelected: "Entfernen ausgewählt",
  previewInNewWindow: "In neuem Fenster öffnen",
  downloadDirectly: "Direkt herunterladen (bei grossen Dateien mit Vorsicht verwenden)",
