# Stable-Diffusion-WebUI百度云拓展

~~Stable-Diffusion-WebUI百度云拓展是一个文件上传下载工具，同时也可以作为图片预览工具，并且有比其他插件更好的性能~~ 

高性能的图片(文件)预览器😋，自带百度云互传。
...
- 支持使用walk模式浏览图片，不翻页浏览所有图片。亲测1w2+文件下正常工作
